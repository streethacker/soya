...
通过制定地区关键字，获取相应地区的天气信息

**请求地址**

```http://localhost:7300/api/weather```
...
```http://localhost:7300/api/weather?location=北京&current_only=1&origin=0```
...
```http://localhost:7300/api/traffic```
...
```http://localhost:7300/api/traffic?location=北京&start_time=2015-04-01&end_time=2015-05-05```
...
```http://localhost:7300/api/movie/hot```
...
```http://localhost:7300/api/movie/hot?location=北京&is_new=0&is_imax=1&movie_score=8.0```
...
```http://localhost:7300/api/search/cinema```
...
```http://localhost:7300/api/search/cinema?location=北京&cinema_name=华星&movie_score=8.5```
...
``` http://localhost:7300/api/search/movie ```
...
```http://localhost:7300/api/search/movie?location=北京&movie_name=速度与激情&rating=3.5```
...
``` http://localhost:7300/api/geocoding ```
...
```http://localhost:7300/api/geocoding?cityname=上海&keyword=近铁城市广场```
...
```http://localhost:7300/api/geocoding/reverse```
...
```http://localhost:7300/api/geocoding/reverse?longitude=121.38149998807&latitude=31.233189678235```
